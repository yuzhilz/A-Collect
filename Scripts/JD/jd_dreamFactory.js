...
function updateInviteCode(url = 'https://raw.githubusercontent.com/799953468/JD_ShareCode/master/jd_dreamFactoryInviteCode.json') {
...
function updateInviteCodeCDN(url = 'https://cdn.jsdelivr.net/gh/799953468/JD_ShareCode@master/jd_dreamFactoryInviteCode.json') {
    return new Promise(resolve => {
        $.get({ url }, async(err, resp, data) => {
            try {
                if (err) {

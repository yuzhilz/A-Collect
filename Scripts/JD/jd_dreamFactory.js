...
function updateTuanIds(url = 'https://raw.githubusercontent.com/799953468/JD_shareCode/master/shareCodes/jd_updateFactoryTuanId.json') {
    return new Promise(resolve => {
...
function updateTuanIdsCDN(url = 'https://raw.fastgit.org/799953468/JD_shareCode/master/shareCodes/jd_updateFactoryTuanId.json') {
    return new Promise(resolve => {
        $.get({ url }, (err, resp, data) => {
            try {
                if (err) {
